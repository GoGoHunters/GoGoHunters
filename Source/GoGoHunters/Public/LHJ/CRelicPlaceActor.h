...
private:
	...
	UPROPERTY(VisibleAnywhere, Category = "Param|DetectCollision",
		meta = (ToolTip = "이 카테고리는 DetectCollision의 Transform 설정을 위한 파라미터들을 모아둡니다."))
	bool bDetectCollisionCategoryDescriptionHelper;
	UPROPERTY(EditAnywhere, Category="Param|DetectCollision", BlueprintReadOnly,
		meta=(AllowPrivateAccess=true, ToolTip="DetectCollision 위치 설정"))
	FVector DetectCollisionLocation = FVector::ZeroVector;
	UPROPERTY(EditAnywhere, Category="Param|DetectCollision", BlueprintReadOnly,
		meta=(AllowPrivateAccess=true, ToolTip="DetectCollision 회전 설정"))
	FRotator DetectCollisionRotation = FRotator::ZeroRotator;
	UPROPERTY(EditAnywhere, Category="Param|DetectCollision", BlueprintReadOnly,
		meta=(AllowPrivateAccess=true, ToolTip="DetectCollision 크기 설정"))
	FVector DetectCollisionSize = FVector(1.2, 1.2, 1);

	UPROPERTY(VisibleAnywhere, Category = "Param|PlaceMesh",
		meta = (ToolTip = "이 카테고리는 PlaceMesh의 Transform 설정을 위한 파라미터들을 모아둡니다."))
	bool bPlaceMeshCategoryDescriptionHelper;
	UPROPERTY(EditAnywhere, Category="Param|PlaceMesh", BlueprintReadOnly,
		meta=(AllowPrivateAccess=true, ToolTip="PlaceMesh 위치 설정"))
	FVector PlaceMeshLocation = FVector::ZeroVector;
	UPROPERTY(EditAnywhere, Category="Param|PlaceMesh", BlueprintReadOnly,
		meta=(AllowPrivateAccess=true, ToolTip="PlaceMesh 회전 설정"))
	FRotator PlaceMeshRotation = FRotator::ZeroRotator;
	UPROPERTY(EditAnywhere, Category="Param|PlaceMesh", BlueprintReadOnly,
		meta=(AllowPrivateAccess=true, ToolTip="PlaceMesh 크기 설정"))
	FVector PlaceMeshSize = FVector(.7, .7, .1);

	UPROPERTY(VisibleAnywhere, Category = "Param|PlaceMesh",
		meta = (ToolTip = "이 카테고리는 DescWidget의 Transform 설정을 위한 파라미터들을 모아둡니다."))
	bool bDescWidgetCompCategoryDescriptionHelper;
	UPROPERTY(EditAnywhere, Category="Param|DescWidget", BlueprintReadOnly,
		meta=(AllowPrivateAccess=true, ToolTip="DescWidget 위치 설정"))
	FVector DescWidgetCompLocation = FVector::ZeroVector;
	UPROPERTY(EditAnywhere, Category="Param|DescWidget", BlueprintReadOnly,
		meta=(AllowPrivateAccess=true, ToolTip="DescWidget 회전 설정"))
	FRotator DescWidgetCompRotation = FRotator::ZeroRotator;
	UPROPERTY(EditAnywhere, Category="Param|DescWidget", BlueprintReadOnly,
		meta=(AllowPrivateAccess=true, ToolTip="DescWidget 크기 설정"))
